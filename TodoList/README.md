...
Создано консольное приложение TodoList для управления задачами с использованием принципов объектно-ориентированного программирования и автоматическим сохранением данных и распределённой архитектурой клиент-сервер. Приложение написано на C#.
...
Задачи хранятся в файле todo.dat (зашифрованный формат)
Профиль хранится в файле profile.dat (зашифрованный формат)
