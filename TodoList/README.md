...
Создано консольное приложение TodoList для управления задачами с использованием принципов объектно-ориентированного программирования и автоматическим сохранением данных. Приложение написано на C#.
